		...
		<div class="container">
			<!-- 01 -->
				<div class="column_wrap">
					<div class="col-md-6">
						<img src="<?=G5_THEME_IMG_URL?>/sub03_02.jpg">
					</div>
					<div class="col-md-6 column_box">
						<!--<h2 class="">Unity3D</h2>-->
						<h3>■ 홈페이지</h3>
						<p>편리한 회원 주소록 관리 시스템으로 회비관리, 그룹별 관리를 쉽고 편하게 할 수 있고 차별화된 커뮤니케이션을 통해 동문회 활동을 더욱 활성화 시킬 수 있습니다.</p>
						<!--<div class="sub02_red">
			...
			<!--<a href="https://monkeycheat1.com/%ea%b0%95%ec%a2%8c%eb%84%a5%ec%8a%a8-%eb%84%b7%eb%a7%88%eb%b8%94-%ec%84%9c%eb%b2%84%ed%84%b0%eb%8a%94-%eb%b0%a9%eb%b2%95-%ec%84%9c%eb%b2%84%ec%97%90-%ed%8c%a8%ed%82%b7%ed%86%b5%ec%8b%a0-%ea%b5%ac/" target="_blank">
				<div class="column_wrap">
					...
					<div class="col-md-6 column_box">
						<h2 class="">서버털기</h2>
						<h3>게임회사 서버터는 방법</h3>
						<p>오늘은 게임사 서버에 구라치는 강좌를 시작하겠습니다.

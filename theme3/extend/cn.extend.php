...
class Menu {
    ...
    function getPageType($str='')
    {
        ...
        else if(preg_match("/privacy.php/", $str)) return "privacy"; // 회원가입
        else if(preg_match("/termofuse.php/", $str)) return "termofuse"; // 회원가입
        else return "etc"; // 기타
    ...
    function viewNav()
    {
        ...
        switch($pageType) {
            case "privacy" :
                $middleMenuTitle = "개인정보처리방침";
                $middleLink = '';
                $menuLength = 1;
                break;

            case "termofuse" :
                $middleMenuTitle = "서비스이용약관";
                $middleLink = '';
                $menuLength = 1;
                break;

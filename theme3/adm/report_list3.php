...
$sql_common = " from report_comment ";
...
<div class="tbl_head01 tbl_wrap new_mem">
    ...
    <tr class="<?php echo $bg; ?>" >
        ...
        <td >
            <a href="<?=G5_BBS_URL?>/board.php?bo_table=<?=$row['bo_table']?>&wr_id=<?=$row['wr_parent']?>&c_id=<?=$row['wr_id']?>#c_<?=$row['wr_id']?>" target="_blank">게시물 바로가기</a>
        </td>
        <td >
            <a href="report_update.php?rp_id=<?=$row['rp_id']?>&mode=comment&sub_num=<?=$sub_num?>"  onclick="return delete_confirm(this, 'report');" class="btn btn_01">신고해제</a>
        </td>
    </tr>
    <?php
    }

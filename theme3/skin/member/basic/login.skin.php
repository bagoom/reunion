...
function RgetPushToken(obj , obj2){
    // alert(obj )
    // alert(obj2)
    $("#login-form input[name=token]").val(obj)
    $("#login-form input[name=device]").val(obj2)
}
</script>
<!-- 로그인 시작 { -->
<div id="mb_login" class="mbskin">
    <div class="mbskin_box">
        ...
        <form name="flogin" id="login-form" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
        ...
        <fieldset id="login_fs">
            ...
            <div id="login_info">
                ...
                <div class="login_if_lpl">
                    <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost">ID / 비밀번호 찾기 </a>  
                </div>
            </div>
        </fieldset> 
        </form>

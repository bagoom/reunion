    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
                ...
                <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" title="삭제" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i></a></li><?php } ?>
        ...
        <div class="promotion_top">
            <div class="flex-box">
                <div class="promotion_logo">
                    ...
                    $view['wr_2'] = set_http($view['wr_2']);
                    ?>
                </div>
                <div class="promotion_info">
                    <ul>
                        <li><?=$view['wr_subject']?></li>
                        <dl>
                            <dt>대표자</dt>
                            <dd><?=$view['wr_1']?></dd>
                        </dl>

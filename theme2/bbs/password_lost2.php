...
$content .= '회원님의 임시 비밀번호를 생성하여 안내해 드립니다.<br>';
$content .= '아래에서 임시 비밀번호를 확인하신 후, <span style="color:#ff3061">하단에 있는 <b>[비밀번호 변경]</b> 메뉴를 클릭 하십시오. </span><br>';
...
$config['cf_admin_email'] = 'contact@wooribannet.com';

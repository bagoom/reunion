                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                         ...
                         <span class="bo_cnt pc-show"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 48, '..'); ?></span>
                         <span class="bo_cnt m-show"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 35, '..'); ?></span>
                    </div>

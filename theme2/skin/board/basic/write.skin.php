...
<section id="bo_w">
    ...
    <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
            ...
            <input type="file" name="bf_file[]" id="bf_file_<?php echo $i+1 ?>"  accept="image/*" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file ">
            <!-- <input type="file" name="bf_file[]" id="bf_file_<?php echo $i+1 ?>" accept="image/*" capture="camera" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file "> -->
        </div>

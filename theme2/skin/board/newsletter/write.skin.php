...
<section id="bo_w">
    ...
    <div class="bo_w_flie write_div">
        <p style="margin: 10px 0 5px; font-size: 14px;">썸네일이미지</p>
        <div class="file_wr write_div">
            <label for="bf_file_0" class="lb_icon"><i class="fa fa-folder-open" aria-hidden="true"></i><span class="sound_only"> 파일 #0</span></label>
            <input type="file" name="bf_file[]" id="bf_file_0" title="파일첨부 0 : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file ">
        </div>

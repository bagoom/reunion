    ...
    <div class="promotion_list">
        <ul>
            <?php for ($i=0; $i<count($list); $i++) { 
                ...
                $writer = get_member($list[$i]['mb_id']);
            ?>
            <li>
                <a href="<?=$list[$i]['href']?>">
                    <div class="content">
                        ...
                        <div class="flex-box">
                            <div class="compay_logo">
                                <div class="logo" style="background-image:url(<?=$file_img1?>)"></div>
                            </div>
                            <div class="compay_info">
                                <div class="title"><?=$list[$i]['subject']?></div>
                                <div class="name">대표 : <?=$list[$i]['wr_1']?> <?=$writer['mb_name']?></div>
                            </div>
                        </div>
                    </div>
                </a>

...
$sql_common = "  mb_name = '{$posts['mb_name']}',
                 ...
                 name2 = '{$posts['name2']}',
                 entrance_year = '{$posts['entrance_year']}',
                 graduation_year = '{$posts['graduation_year']}',
                 entrance_num = '{$posts['entrance_num']}',
                 job = '{$posts['job']}',
                 job_department = '{$posts['job_department']}',
                 job_position = '{$posts['job_position']}',
                 workplace_addr = '{$posts['workplace_addr']}',
                 workplace_tel = '{$posts['workplace_tel']}',
                 addr = '{$posts['addr']}',

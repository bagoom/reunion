...
// define('G5_MYSQL_PASSWORD', 'dnwls1127');
// define('G5_MYSQL_DB', 'reunion');
// define('G5_MYSQL_SET_MODE', true);
define('G5_MYSQL_HOST', '210.106.105.235');
define('G5_MYSQL_USER', 'root');
define('G5_MYSQL_PASSWORD', 'dnflqksspt1');
define('G5_MYSQL_DB', 'reunion');
define('G5_MYSQL_SET_MODE', true);  
...
$g5['fee'] = 'fee'; // 회비 관리 테이블
$g5['branch'] = 'branch'; // 지회 관리 테이블
$g5['branch_member'] = 'branch_member'; // 지회멤버 관리 테이블

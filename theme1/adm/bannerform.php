...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="reunion">구분</label></th>
        <td>
            <?php echo help("배너를 게시할 학교 구분을 선택해주세요."); ?>
            <?= get_reunion_select2('reunion_id', $mb['affiliation'], 'required', 'reunion_title', 'reunion'); ?>
        </td>
    </tr>
    <tr>
        <th scope="row">이미지</th>
    ...
    <tr>
        ...
        <td>
			...
			<?php echo htmlspecialchars("개별 출력 (배너ID 지정출력) : <?php echo display_banner2('개별', '배너ID'); ?>"); ?><br>
           <?php echo htmlspecialchars("일반 출력 (세로정렬) : <?php echo display_banner2('일반'); ?>"); ?><br>
		   <?php echo htmlspecialchars("슬라이드 출력 (좌우 슬라이드) : <?php echo display_banner2('슬라이드'); ?>"); ?><br>
		   <?php echo htmlspecialchars("랜덤 출력 (새로고침시 랜덤출력) : <?php echo display_banner2('랜덤'); ?>"); ?><br>
